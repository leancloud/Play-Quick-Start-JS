...
declare namespace cc {
  ...
  /**
	...
	*/
  export function pLineIntersect(
    A: Vec2,
    B: Vec2,
    C: Vec2,
    D: Vec2,
  ...
  /**
	...
	@param D D 
	*/
  export function pSegmentIntersect(
    A: Vec2,
    B: Vec2,
    C: Vec2,
    D: Vec2
  ...
  /**
	...
	*/
  export function V3F_C4B_T2F_QuadCopy(
  ...
  export class RawAsset extends Object {
    /**
		...
		@param callback callback 
		*/
    static createNodeByInfo(
      Info: any,
      callback: (error: string, node: any) => void
    ): void;
  }
...
declare namespace dragonBones {
  ...
  abstract class BaseObject {
     ...
     */
    static setMaxCount(
      objectConstructor: typeof BaseObject,
      maxCount: number
    ): void;
    /**
     * @language zh_CN
...
declare namespace dragonBones {
  ...
  abstract class DataParser {
    ...
    protected _mergeFrameToAnimationTimeline(
      framePostion: number,
      actions: Array<ActionData>,
      events: Array<EventData>
    ): void;
...
declare namespace dragonBones {
  ...
  class ObjectDataParser extends DataParser {
     ...
     * @private
     */
    protected static _getParameter(
      rawData: Array<any>,
      index: number,
      defaultValue: any
    ): any;
     ...
     * @private
     */
    protected _parseTweenFrame<T extends TweenFrameData<T>>(
      rawData: any,
      frame: T,
      frameStart: number,
      frameCount: number
     ...
     * @private
     */
    protected _parseFrame<T extends FrameData<T>>(
      rawData: any,
      frame: T,
      frameStart: number,
      frameCount: number
     ...
     * @private
     */
    protected _parseTimeline<T extends FrameData<T>>(
      rawData: Object,
      timeline: TimelineData<T>,
      frameParser: (rawData: any, frameStart: number, frameCount: number) => T
    ): void;
    /**
     * @private
     */
     ...
     * @private
     */
    protected _parseColorTransform(
      rawData: Object,
      color: ColorTransform
    ): void;
    /**
...
declare namespace dragonBones {
  ...
  abstract class BaseFactory {
     ...
     * @private
     */
    protected abstract _generateTextureAtlasData(
      textureAtlasData: TextureAtlasData,
      textureAtlas: any
    ): TextureAtlasData;
    /**
     * @private
     */
    protected abstract _generateArmature(
      dataPackage: BuildArmaturePackage
    ): Armature;
    /**
     * @private
     */
    protected abstract _generateSlot(
      dataPackage: BuildArmaturePackage,
    ...
    copyAnimationsToArmature(
      ...
      ifRemoveOriginalAnimationList?: boolean
    ): boolean;
    /**
     * @language zh_CN
